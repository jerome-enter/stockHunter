...
| 지표 | 조건 | 기간 | 비고 |
|------|------|------|------|
| 이동평균 | 주가 vs MA | 60, 112, 224일 | 비율(%) 기준 |
| 볼린저밴드 | 주가 위치 | - | 하단/중단/상단 |
| 거래량 | 전일 대비 | - | 배수 |
| 이평선 정배열 | 60 > 112 > 224 | - | 상승추세 확인 |
...
2. 전일종가 / 112일선: 95% ~ 105%
3. 전일종가 / 224일선: 95% ~ 105%
4. 거래량: 전일 대비 1.5배 이상 (옵션)
5. 이평선 정배열: 60 > 112 > 224 (옵션)
6. 볼린저밴드: 하단/중단/상단 선택 (옵션)
7. 관리종목 제외: 기본 활성화
8. ETF/ETN 제외: 기본 활성화
```
